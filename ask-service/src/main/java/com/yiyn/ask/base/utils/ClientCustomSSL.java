...
public class ClientCustomSSL {
	...
	private static String apiclient_certLocation = "wechat/cert/apiclient_cert.p12";

    public static String doRefund(WeixinConfig weixinConfig, String url,String data) throws Exception {
        ...
        InputStream instream = ClientCustomSSL.class.getClassLoader().getResourceAsStream(apiclient_certLocation);
        try {
