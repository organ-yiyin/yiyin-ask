...
public class DateFormatTemplate {
    ...
    public final static String DATE_FORMAT_ENGLISH = "d MMM.yyyy";
    ...
    public final static String DATE_TIME_FORMAT_COMPACT_DOT_S = "yyyy-MM-dd HH:mm:ss.SSS";
	...
	public static void main(String[] args){
		...
		SimpleDateFormat dateFormat = new SimpleDateFormat(DATE_FORMAT_ENGLISH, Locale.ENGLISH);
