...
(function($){
	if ($.validator) {
		...
		$.validator.addMethod("identify", function(value, element, params) {
			return this.optional(element) || /^\d{6}\d{2}(1[012]|0\d)([012]\d|3[01])\d{3}$/.test(value) || /^\d{6}(19|2\d)\d{2}(1[012]|0\d)([012]\d|3[01])\d{3}[\dXx]$/.test(value);
		}, "Please enter a valid identify.");
